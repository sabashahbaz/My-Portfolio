        ...
        <Container>
            ...
            <span className="navbar-text ">
                <div className="social-icon px-2">
                    <a href="https://www.linkedin.com/in/saba-shahbaz/" target="_blank"><img src={navIcon1} alt="" /></a>
                    <a href="https://github.com/sabashahbaz"  target="_blank"><img src={navIcon2} alt=""  /></a>
